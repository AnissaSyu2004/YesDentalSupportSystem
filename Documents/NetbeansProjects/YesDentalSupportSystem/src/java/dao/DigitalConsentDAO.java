...
public class DigitalConsentDAO {
    ...
    // Add new digital consent
    public boolean addDigitalConsent(DigitalConsent consent) {
        String sql = "INSERT INTO digitalconsent (consent_id, patient_ic, consent_context, consent_signdate) " +
                    "VALUES (?, ?, ?, ?)";
    ...
    public DigitalConsent getConsentByAppointmentId(String appointmentId) {
        String sql = "SELECT dc.* FROM digitalconsent dc " +
                    "JOIN appointment a ON dc.patient_ic = a.patient_ic " +
                    "WHERE a.appointment_id = ? " +
                    "ORDER BY dc.consent_signdate DESC LIMIT 1";
    ...
    public boolean hasConsentForAppointment(String appointmentId) {
        String sql = "SELECT COUNT(*) FROM digitalconsent dc " +
                    "JOIN appointment a ON dc.patient_ic = a.patient_ic " +
                    "WHERE a.appointment_id = ?";
